...
{Code excerpt showing the \code{handle\_syscall\_read} implementation.}

\codefig{syscall-write}{proc/syscall.c}{231}{240}
{Code excerpt showing the \code{handle\_syscall\_write} implementation.}
